...
def download_tiktok(url, chat_id, quality='medium'):
    ...
    try:
        ...
        return None, None, "Failed to download TikTok media or file too large."

    except Exception as e:
        return None, None, f"Error downloading TikTok media: {str(e)}"