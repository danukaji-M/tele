...
def download_facebook(url, chat_id, quality='medium'):
    ...
    try:
        ...
        return None, None, "Failed to download Facebook media or file too large."

    except Exception as e:
        return None, None, f"Error downloading Facebook media: {str(e)}"